...
* */
public class ArtistListAdapter extends ArrayAdapter<MusicList> {
     ...
     */
    public ArtistListAdapter(Activity context, ArrayList<MusicList> musicList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView artistTextView = (TextView) listItemView.findViewById(R.id.song_name);
